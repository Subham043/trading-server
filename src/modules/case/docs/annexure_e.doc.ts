...
export const generateAnnexureEDoc: (
  payload: ANNEXUREEDocType,
  outputPath: string
  ...
  return new Promise((resolve, reject) => {
      ...
      sections: [
        {
          ...
          children: [
            ...
            new Paragraph({
              children: [
                new TextRun({
                  text: `That Mr. /Ms. ${payload.shareholderNameDeath} was holding the following securities:`,
                  size: 25,
                  font: "Calibri",
                }),
              ],
            ...
            new Paragraph({
              children: [
                new TextRun({
                  text: `That the aforesaid deceased holder died intestate on ${
                    payload.isInTestate ? payload.dod : ""
                  }, without registering any nominee, leaving behind him/her the following persons as the only surviving legal heirs, according to the laws of intestate succession applicable to him/her by which he/she was governed at the time of his/her death.`,
                  size: 25,
                  font: "Calibri",
                }),
              ],
            ...
            new Paragraph({
              children: [
                new TextRun({
                  text: `That the aforesaid deceased holder died on ${
                    payload.isTestate ? payload.dod : ""
                  }, without registering any nominee, leaving behind him/her the following persons as the only surviving legal heirs, according to the laws of testamentary succession.`,
                  size: 25,
                  font: "Calibri",
                }),
              ],
            ...
            new Paragraph({
              children: [
                new TextRun({
                  text: `In consideration therefore of my/our request to transfer/transmit the above said securities to the name of the undersigned Mr. /Ms. ${payload.clamaints_pan_name}`,
                  size: 25,
                  font: "Calibri",
                }),
              ],
            ...
            new Paragraph({
              children: [
                new TextRun({
                  text: `I/We hereby jointly and severely agree and undertake to indemnify and keep indemnified, saved, defended, harmless, ${payload.companyName}, ${payload.companyRTA} and its successors and assigns for all time hereafter against all losses, costs, claims, actions, demands, risks, charges, expenses, damages, etc., whatsoever which they may suffer and/or incur by reason of transferring the said securities as herein above mentioned, at my/our request to the undersigned Mr./Ms. ${payload.clamaints_pan_name} without insisting on production of a Succession Certificate / Probate of Will / Letter of Administration or any Court order.`,
                  size: 25,
                  font: "Calibri",
                }),
              ],
    ...
    Packer.toBuffer(doc)
      .then((buffer) => {
        ...
        resolve("✅ ANNEXURE_E_Generated.docx has been created.");
      })
