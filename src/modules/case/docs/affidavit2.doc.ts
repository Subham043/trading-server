...
export const generateAffidavit2Doc: () => void = () => {
    ...
    sections: [
      {
        ...
        children: [
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: "I {namePan}, {deceasedRelationship} of {shareholderNameDeath},	aged	about	 {age}	years,	and	residing	at {addressBank} do hereby solemnly affirm and declare as under:",
                size: 25,
                font: "Calibri",
              }),
            ],
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: "1. I am the {deceasedRelationship} of {shareholderNameDeath} and I am fully aware of the facts and circumstances.",
                size: 25,
                font: "Calibri",
              }),
            ],
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: "2. In the records of {companyName}, the name of the first/joint holder recorded is {namePan}. In the death certificate issued by the Corporation of {placeOfDeath} the name has been recorded as {namePan}.",
                size: 25,
                font: "Calibri",
              }),
            ],
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: "3. I state that {namePan} was also known as {namePan} and that both names belong to one and the same person.",
                size: 25,
                font: "Calibri",
              }),
            ],
