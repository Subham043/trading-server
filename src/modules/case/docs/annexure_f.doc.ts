...
export const generateAnnexureFDoc: () => void = () => {
    ...
    sections: [
      {
        ...
        children: [
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: "I/We, {#clamaints}{namePan}; {/} the legal heir(s) of late Mr. / Ms {shareholderNameDeath} declare as follows – ",
                size: 25,
                font: "Calibri",
              }),
            ],
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: "(ii) That the deceased had died intestate on  {dod} .and without registering any nominee. ",
                size: 25,
                font: "Calibri",
              }),
            ],
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: "(vi) Accordingly, I / we declare that I / we have NO OBJECTION WHATSOEVER in {companyName} transmitting the aforesaid securities in favour of the Claimant(s) Mr./Ms. {#clamaints}{namePan}; {/}.",
                size: 25,
                font: "Calibri",
              }),
            ],
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: "(vi) I / we hereby state that whatever is stated herein above are true to the best of my/our knowledge and nothing has been concealed therein.",
                size: 25,
                font: "Calibri",
              }),
            ],
