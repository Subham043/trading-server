...
export const generateFormADoc: () => void = () => {
    ...
    sections: [
      {
        ...
        children: [
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: "1. That I/We, {#hasShareholder_1}{shareholderNameCertificate_1}; {/hasShareholder_1} {#hasShareholder_2}{shareholderNameCertificate_2}; {/hasShareholder_2} {#hasShareholder_3}{shareholderNameCertificate_3}; {/hasShareholder_3} hold the following (number of) securities under below mentioned folio(s),pertain to  understated company  in my/ our name as single holder / joint holder:",
                size: 25,
                font: "Calibri",
              }),
            ],
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: "2. I/We {#hasShareholder_1}{shareholderNameCertificate_1}; {/hasShareholder_1} {#hasShareholder_2}{shareholderNameCertificate_2}; {/hasShareholder_2} {#hasShareholder_3}{shareholderNameCertificate_3}; {/hasShareholder_3} further swear / solemnly declare that I/ we am/are applying for issue of duplicate certificate(s) to me/us on the ground that the original security(ies) certificate(s) has/have been misplaced / not found by me/us, despite a diligent search made by me/us in this behalf.",
                size: 25,
                font: "Calibri",
              }),
            ],
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: "3. I/We {#hasShareholder_1}{shareholderNameCertificate_1}; {/hasShareholder_1} {#hasShareholder_2}{shareholderNameCertificate_2}; {/hasShareholder_2} {#hasShareholder_3}{shareholderNameCertificate_3}; {/hasShareholder_3} further swear /solemnly declare that the said securities are not sold or pledged or deposited by way of security to any person/company.",
                size: 25,
                font: "Calibri",
              }),
            ],
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: "4. I/We {#hasShareholder_1}{shareholderNameCertificate_1}; {/hasShareholder_1} {#hasShareholder_2}{shareholderNameCertificate_2}; {/hasShareholder_2} {#hasShareholder_3}{shareholderNameCertificate_3}; {/hasShareholder_3} here by further swear / solemnly declare that if, after the duplicate share certificate(s) is / are issued to us as aforesaid, the original security(ies) certificate(s) is / are at any time subsequently, found, recovered or traced by us or by anyone on our behalf, then, we unconditionally undertake not to deal with the said original share certificate(s) in any manner whatsoever (whether by physical transfer or dematerialization or as security or pledge) and further unconditionally undertake to promptly surrender the original share certificate(s) to the RTA / Company, for cancellation.",
                size: 25,
                font: "Calibri",
              }),
            ],
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: "5. I/We {#hasShareholder_1}{shareholderNameCertificate_1}; {/hasShareholder_1} {#hasShareholder_2}{shareholderNameCertificate_2}; {/hasShareholder_2} {#hasShareholder_3}{shareholderNameCertificate_3}; {/hasShareholder_3} am/are making the above solemn declaration on oath with full knowledge of the fact that in the event the original security(ies) certificate(s) issued is /are found, recovered and traced by me/us and instead of surrendering the same is / are dealt with by me/us as aforesaid, the Company will be at liberty to adopt civil and / or criminal proceedings against me/us for my/our failure to promptly surrender the original security(ies) certificate(s), for cancellation and for breach of my/our solemn declaration and undertaking not to deal with the original security(ies) certificate(s) in any manner whatsoever as aforesaid at my/our entire risk as to cost and consequences. ",
                size: 25,
                font: "Calibri",
              }),
            ],
