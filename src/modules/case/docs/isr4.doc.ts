  ...
  return new Promise((resolve, reject) => {
                    ...
                    new TableCell({
                      children: [
                        new Paragraph({
                          children: [
                            new TextRun({
                              text: `PAN : ${payload.pan ? payload.pan : ""}`,
                              size: 25,
                            }),
                          ],
                        }),
                    ...
                    new TableCell({
                      children: [
                        new Paragraph({
                          children: [
                            new TextRun({
                              text: payload.shareholderCertificateNames,
                              size: 25,
                            }),
                          ],
                        }),
                    ...
                    new TableCell({
                      children: [
                        new Paragraph({
                          children: [
                            new TextRun({
                              text: payload.certificateNumbers,
                              size: 25,
                            }),
                          ],
                        }),
                    ...
                    new TableCell({
                      children: [
                        ...
                        new Paragraph({
                          children: [
                            new TextRun({
                              text: payload.combinedTotalFaceValue.toString(),
                              size: 25,
                            }),
                          ],
                        }),
                    ...
                    new TableCell({
                      children: [
                        new Paragraph({
                          children: [
                            new TextRun({
                              text: `(in numbers) ${payload.combinedTotalNoOfShares}`,
                              size: 25,
                            }),
                          ],
                        }),
                        new Paragraph({
                          children: [
                            new TextRun({
                              text: `(in words) ${payload.combinedTotalNoOfSharesWords}`,
                              size: 25,
                            }),
                          ],
                        }),
    ...
    Packer.toBuffer(doc)
      .then((buffer) => {
        ...
        resolve("✅ ISR4_Generated.docx has been created.");
      })
