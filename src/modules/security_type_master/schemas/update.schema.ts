...
import { getById } from "../security_type_master.repository";

export const updateSecurityTypeMasterBodySchema = z.object({
...
export const updateSecurityTypeMasterUniqueSchema = z.object({
  id: z
    .number({
