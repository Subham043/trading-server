...
import {
  ...
  listAll,
  update,
} from "./referral_tracker_stage.services";
...
export async function listReferralTrackerStages(
  ...
  return reply.code(200).type("application/json").send({
    code: 200,
    success: true,
    message: "ReferralTrackerStages Fetched",
    data: result,
  });
}

export async function listAllReferralTrackerStages(
  request: FastifyRequest<{
    Querystring: GetPaginationQuery;
  }>,
  reply: FastifyReply
...
export async function exportReferralTrackerStages(
  request: FastifyRequest<{
    Params: paymentTrackerIdParam;
 ...
 */
export async function getReferralTrackerStage(
  request: FastifyRequest<{
    Params: GetIdParam;
  }>,
  reply: FastifyReply
  ...
  return reply.code(200).type("application/json").send({
    code: 200,
    success: true,
    message: "ReferralTrackerStage Fetched",
    data: result,
  });
}
...
export async function createReferralTrackerStage(
  request: FastifyRequest<{
    Params: paymentTrackerIdParam;
    Body: ReferralTrackerStageCreateType;
  }>,
  reply: FastifyReply
): Promise<void> {
  ...
  return reply.code(201).type("application/json").send({
    code: 201,
    success: true,
    message: "ReferralTrackerStage Created",
    data: result,
  });
}
...
export async function updateReferralTrackerStage(
  request: FastifyRequest<{
    Body: ReferralTrackerStageUpdateType;
    Params: GetIdParam;
  }>,
  reply: FastifyReply
): Promise<void> {
  ...
  return reply.code(200).type("application/json").send({
    code: 200,
    success: true,
    message: "ReferralTrackerStage Updated",
    data: result,
  });
}
 ...
 */
export async function removeReferralTrackerStage(
  request: FastifyRequest<{
    Params: GetIdParam;
  }>,
  reply: FastifyReply
  ...
  return reply.code(200).type("application/json").send({
    code: 200,
    success: true,
    message: "ReferralTrackerStage Removed",
    data: result,
  });
}

export async function removeMultipleReferralTrackerStages(
  request: FastifyRequest<{
    Body: GetIdsBody;
  }>,
  reply: FastifyReply
  ...
  return reply.code(200).type("application/json").send({
    code: 200,
    success: true,
    message: "ReferralTrackerStages Removed",
  });
}
